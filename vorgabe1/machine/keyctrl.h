...
class Keyboard_Controller
 {
private:
    Keyboard_Controller(const Keyboard_Controller &other) = delete; // Verhindere Kopieren
    Keyboard_Controller& operator=(const Keyboard_Controller& other) = delete; // Verhindere Kopieren
private:
    unsigned char code;
